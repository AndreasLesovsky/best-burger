...
$anzDSeProSeite = 20; //Anzahl der Datensätze pro Seite
		...
		<section id="reservations">
			<div class="wrapper-inner">
				...
				<form method="post">
					...
					<input type="hidden" name="sortorderDate" value="<?php echo($sortorderNN); ?>">
					<button type="submit" name="btnChangePage" value="-1">
					...
					<table>
						<thead>
							...
							<tr>
								<td></td>
								<td><input type="text" name="fltrName" placeholder="Nach Name suchen"></td>
								<td><input type="email" name="fltrEmail" placeholder="Nach Emailadresse suchen"></td>
								<td><input type="tel" name="fltrTel" placeholder="Nach Telefonnr. suchen"></td>
								<td><input type="date" name="fltrDate"></td>
								<td></td>
								<td><input type="number" name="fltrTable" placeholder="Nach Tischnr. suchen"></td>
								<td>
