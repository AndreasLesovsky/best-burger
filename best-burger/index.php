...
if (count($_POST) > 0) {
	...
	$phone = $_POST['phone'];
	$resDate = $_POST['resTag'];
	$resHour = $_POST['resHour'];
	$resMinute = $_POST['resMinute'];
	...
	<main>
		<section>
			<div class="wrapper-inner">
				<div class="content">
					...
					<a href="#reserve" class="link-btn">Jetzt Reservieren!</a>
				</div>
		...
		<section id="all-stars">
			<div class="wrapper-inner">
				...
				<a href="#burgers" class="link-btn">Alle Burger</a>
			</div>
		</section>
			...
			<div class="wrapper-inner">
				...
				<form id="reservation-form" method="post">
					<div id="restaurantMap">
						...
						<button type="button" id="checkAvailabilityBtn" class="link-btn">Freie Tische?</button>
						<div>
							<img src="media/restaurant-map-removebg-preview.png" alt="Restaurant Map">
							<button type="button" id="table1" class="table-button"><span>Tisch </span>1</button>
							<button type="button" id="table2" class="table-button"><span>Tisch </span>2</button>
							<button type="button" id="table3" class="table-button"><span>Tisch </span>3</button>
							<button type="button" id="table4" class="table-button"><span>Tisch </span>4</button>
							<button type="button" id="table5" class="table-button"><span>Tisch </span>5</button>
							<button type="button" id="table6" class="table-button"><span>Tisch </span>6</button>
							<button type="button" id="table7" class="table-button"><span>Tisch </span>7</button>
